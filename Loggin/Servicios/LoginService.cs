...
public class LoginService : ILogin
{
    ...
    public async Task<SalidaLogin> login(string usuario, string password)
    {
        ...
        try
        {
            ...
            var user = await con.QueryFirstOrDefaultAsync<Usuario>(query, new { usuario, password });
        ...
        {
            salida.respuestaBD = new RespuestaBD($"ERROR|Error al Crear la Operación. {ex.Message}");
        }
